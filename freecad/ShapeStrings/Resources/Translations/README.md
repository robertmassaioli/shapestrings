...
at <https://crowdin.com/project/freecad-addons> webpage and find the **advanced_shapestrings** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **advanced_shapestrings** translatable strings execute
...
Also you can rename new `advanced_shapestrings.ts` file by appending the locale code,
...
once done, look for the **advanced_shapestrings** project.
...
Now you can contribute your translated `.ts` file to **advanced_shapestrings** repository,
also include the `.qm` file.

<github.com/echo_rm/advanced-shapestrings>
