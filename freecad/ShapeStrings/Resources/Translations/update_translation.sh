...
# - The script has to be executed within the `freecad/ShapeStrings/Resources/Translations` directory.
...
# - Once done, download the translated files, copy them to `freecad/ShapeStrings/Resources/Translations`
